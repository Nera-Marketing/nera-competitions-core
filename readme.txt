...
= 1.3.24 =
* Added: Attribution Page Editor **Page URL slug** field to change the public path of the Nera Marketing attribution page (default `competition-website-by-nera-marketing`); previous slug 301s to the new URL.
