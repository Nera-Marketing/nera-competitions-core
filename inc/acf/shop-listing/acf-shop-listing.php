...
function nera_register_shop_listing_fields(): void
{
  ...
  acf_add_local_field_group([
    ...
    'fields' => [
      ...
      [
        'key' => 'field_shop_tab_empty',
        'label' => __('Empty state', 'nera-competitions'),
        'type' => 'tab',
        'placement' => 'top',
      ],
      [
        'key' => 'field_shop_empty_heading',
        'label' => __('Heading', 'nera-competitions'),
        'name' => 'product_listing_empty_heading',
        'type' => 'text',
        'instructions' => __(
          'Shown on the Shop page when there are no competitions at all.',
          'nera-competitions',
        ),
      ...
      [
        'key' => 'field_shop_empty_description',
        ...
        'default_value' => __('Check back soon for new amazing prizes!', 'nera-competitions'),
        'rows' => 3,
        'new_lines' => '',
      ],
    ],
