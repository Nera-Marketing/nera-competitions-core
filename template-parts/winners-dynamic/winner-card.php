...
<article
  class="group bg-surface rounded-2xl sm:rounded-3xl overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 border border-gray-100 flex flex-col sm:flex-row sm:items-stretch h-full">
  ...
  <div class="p-3 sm:p-5 flex flex-col flex-1 min-w-0 justify-center gap-1.5 sm:gap-2.5">
    <h2 class="text-sm sm:text-lg font-bold text-text-primary leading-snug line-clamp-2">
